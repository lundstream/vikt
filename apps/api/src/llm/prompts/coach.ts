...
- Varje område i underlaget har en rad som börjar med "Vad det betyder:". Tar du upp området tar du med den tolkningen, med dina egna ord men utan att ändra vad den säger. Du lägger aldrig till en egen tolkning av vad något betyder, och du hittar aldrig på en tolkning för ett område som saknar en sådan rad. Orden "i regel", "för de flesta", "oftast" och "brukar" står kvar, för de säger att påståendet är allmänt och inte något appen räknat fram om just den här personen.`;
