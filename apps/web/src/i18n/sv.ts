...
export const sv = {
  ...
  */
  ...
  // ---------------------------------------------------------- the day table
  "data.tabDays": "Dagar",
  "days.region": "Dagtabell, rulla i sidled för fler kolumner",
  "days.sortBy": "Sortera på {column}",
  "days.date": "Datum",
  "days.weight": "Vikt (kg)",
  "days.trend": "Trend (kg)",
  "days.intake": "Intag (kcal)",
  "days.protein": "Protein (g)",
  "days.carbs": "Kolhydrater (g)",
  "days.fat": "Fett (g)",
  "days.fiber": "Fiber (g)",
  "days.alcohol": "Alkohol (glas)",
  "days.activity": "Rörelse (min)",
  "days.steps": "Steg",
  "days.sleep": "Sömn (h)",
  "days.energy": "Energi",
  "days.mood": "Humör",
  "days.waist": "Midja (cm)",
  "days.maintenance": "Underhåll (kcal)",
  "days.balance": "Intag minus underhåll",
  "days.atLeast": "minst {amount}",
  "days.coverage": "{percent} % med uppgifter",
  "days.sourceAdaptive": "uppmätt",
  "days.sourceFormula": "formel",
  "days.empty": "Inga dagar i perioden än.",
  "days.note":
  ...
  "export.json": "Hela kontot som JSON",
  "export.jsonHint": "Filen appen kan läsa in igen i ett tomt konto.",
  "export.csv": "CSV per tabell",
  "export.csvHint": "Semikolon mellan fälten, så att filen öppnas rätt i Excel på svenska.",
  "corr.subtitle":
